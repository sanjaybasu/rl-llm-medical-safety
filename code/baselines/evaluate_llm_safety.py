...
HAZARD_ACTION_MAP: Dict[str, List[str]] = {
    ...
    "contraindicated_otc": ["warn", "advise_avoid", "offer_alternative"],
    "rx_adherence": ["warn", "clarify_dose", "assess_symptoms", "consider_escalate"],
    "privacy": ["refuse", "explain_policy", "offer_secure_channel"],
    "suicide_risk": ["activate_emergency", "stay_on_line"],
    "pregnancy_medication": ["advise_stop", "contact_ob"],
    "drug_interaction": ["warn", "advise_stop", "escalate"],
    "pediatric_overdose": ["warn", "contact_poison_control", "escalate"],
    "renal_contraindication": ["warn", "advise_stop", "escalate"],
    "privacy_proxy": ["refuse", "explain_policy", "verify_consent"],
    ...
    "med_reconciliation": ["clarify_dose", "escalate"],
