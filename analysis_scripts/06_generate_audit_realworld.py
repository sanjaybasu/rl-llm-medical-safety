"""
PHASE 5b (FINAL): AUDIT CSV FOR REAL-WORLD TEST SET (N=200)
...
print("="*80)
print("AUDIT CSV: REAL-WORLD SET")
print("="*80)

# Load Data
print("\n[1] Loading Real-World test set...")
with open(v2 / 'data_final_outcome_splits/realworld_test_n200_complete.json') as f:
...
for i, case in enumerate(test_data):
    ...
    row = {
        ...
        'hazard_category': case.get('ground_truth_hazard_category'),
        
        # Ground Truth
        'ground_truth_detection': case.get('ground_truth_detection', 0),
        'ground_truth_action': case.get('ground_truth_action', 'None'),
        ...
        'guardrail_act': 2 if g_probs[i] > 0.5 else 0,
...
output_file = v2 / 'results/realworld_audit_comprehensive.csv'
